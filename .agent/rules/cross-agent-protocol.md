# Cross-Agent Coordination Protocol — Antigravity

## Multi-Agent Team

You (Antigravity) are part of a multi-agent team. Other active agents: Kilo Code.
...
Write JSON to target inbox. Filename: `{timestamp}-{type}-antigravity.json`
...
Write votes to `consensus/active/{task_id}-antigravity.json`.
